    ...
    return (
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            <div className="flex flex-col">
                ...
                <input type="text" id="name" placeholder="Digite seu nome" className="rounded-md py-2 px-2 text-sm" value={name} onChange={(e) => setName(e.target.value)}/>
            </div>

            <div className="flex flex-col">
                <label className="text-sm" htmlFor="email">E-mail</label>
                <input type="email" id="email" placeholder="Digite seu melhor e-mail" className="rounded-md py-2 px-2 text-sm" value={email} onChange={(e) => setEmail(e.target.value)}/>
            </div>
